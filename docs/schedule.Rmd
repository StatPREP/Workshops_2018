...
5. Brief presentations of lessons developed
    ...
    - Hartford Corrections data in [HTML](HartfordLessons/correctionsdata.html) and [Rmd](HartfordLessons/correctionsdata.Rmd) and the [data set](HartfordLessons/Correctional_Facility_Daily_Population_Count_By_Facility.csv)
