...
1. Exploring statistics using StatPREP materials.
...
4. Determining lesson-development groups. [Homework answers](homework.html)
...
6. Brief presentations of lessons developed
    - [St Paul Parks and Rec Survey](StPaulRecSurvey/ParksAndRecSurvey.html)
    - Hartford
