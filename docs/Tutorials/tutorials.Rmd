...
```{r echo = FALSE}
div(class = "row",
    functions_thumb, formulas_thumb, data_frames_thumb, counting_thumb, dfstats_thumb, densities_thumb, conventional_graphics_thumb, data_graphics_thumb, data_verbs_thumb, workshop_wrangling_thumb, regression_thumb, classical_inference_thumb
)
```
...
read_class_data_thumb <- 
  app_thumbnail("http://dtkaplan.shinyapps.io/Lesson_read_class_data.png", 
                ...
                "Accessing data on a Google spreadsheet✐")
```

```{r echo = FALSE}
div(class = "row",
    first_day_thumb, globe_toss_thumb, riverboat_thumb, read_class_data_thumb
)
```
