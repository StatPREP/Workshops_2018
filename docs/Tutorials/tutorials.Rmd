...
```{r echo = FALSE}
div(class = "row",
    functions_thumb, formulas_thumb, data_frames_thumb, counting_thumb, dfstats_thumb, densities_thumb, conventional_thumb, data_graphics_thumb, data_verbs_thumb, workshop_wrangling_thumb, globe_toss_thumb
)
```
